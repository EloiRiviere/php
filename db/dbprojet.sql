...
-- Généré le :  Mer 02 Janvier 2019 à 01:04
...
('News 7', 'Incroyable', '2018-12-13', "Trois élèvent restent jusqu'à 19h30 pour finir un projet de php", 'http://www.crouton.net');
...
INSERT INTO `visiteur` (`id_visit`, `login`, `password`, `mail`) VALUES
(1, 'jean', 'jean', 'jean@jean.fr'),
(2, 'gaspard', 'gaspard', 'gaspard@gaspard.fr'),
(3, '', '', 'vide@vide.fr');
...
--
ALTER TABLE `visiteur`
  MODIFY `id_visit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
